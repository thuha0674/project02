            ...
            <div class="contaier">
                <div class="row">
                    <div class="col">
                        ...
                        <button type="button" class="btn-primary my-btn">Add Category</button>
                        <!-- table -->
                            ...
                            <table class="table table1 table-image mx-auto">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1.</td>
                                        <td>Pizza</td>
                                        <td><img class="my-img"src="img/pizza.jpg" class="img-fluid img-thumbnail" alt=""></td>
                                        <td>Yes</td>
                                        <td>Yes</td>
                                        <td>
                                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                <div class="btn-group me-2" role="group" aria-label="First group">
                                                    <button type="button" class="btn btn-primary my-btn">Update Category</button>
                                                </div>
                                                <div class="btn-group" role="group" aria-label="First group">
                                                    <button type="button" class="btn btn-info my-btn">Delete Category</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2.</td>
                                        <td>Burger</td>
                                        <td><img class="my-img"src="img/burger.jpg" class="img-fluid img-thumbnail" alt=""></td>
                                        <td>Yes</td>
                                        <td>Yes</td>
                                        <td>
                                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                    ...
                                    <tr>
                                        <td>3.</td>
                                        <td>MoMo</td>
                                        <td><img class="my-img"src="img/momo.jpg" class="img-fluid img-thumbnail" alt=""></td>
                                        <td>Yes</td>
                                        <td>Yes</td>
                                        <td>
                                            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
